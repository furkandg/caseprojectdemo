...
var DocumentModel = function (params) {
    ...
    this.LineID = 0;
    this.GlobalID =  params.GlobalID || params.GLOBALID || "";
...
jQuery.fn.extend({
    UploaderJS: function (params) {
        ...
        var _domManage = function () {
            ...
            var _loadItem = function (dataItem) {
                ...
                if (ImageExtentions.indexOf(_itemExt) != -1) {
                    var _imageNode = $('<img src="' + dataItem.Thumbnail.replace("~", dataItem.ServerUrl) + '" />');
                    _itemIconNode.append(_imageNode);
                    _imageSlider.addItem(_imageNode, dataItem);
                }
                else {
                    var _imageNode = $('<img src="' + _this_path_uploader + "/images/" + _getFileExt(dataItem.Ext) + '.png" />');
                    _itemIconNode.append(_imageNode);
                }
                ...
                //Data inputs
                if (dataItem.GlobalID == null || dataItem.GlobalID == "") {
        ...
        var _constructure = function () {
            ...
            } else if (model.GlobalID != null || model.GlobalID != "") {
